...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        GenerateFrameControl window = new GenerateFrameControl(600, 530, "App", gridX, gridY, game);

        window.generateWindow();
    }
}

/*The player has to have at least 8 tiles around him tinted his color to be safe, if he is not safe, then the other player
